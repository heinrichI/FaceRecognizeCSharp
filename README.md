...
- **Правый клик** → Add to known (для неизвестных лиц) — добавить лицо в базу (выбор имени из существующих или ввод нового)
- **Правый клик** → Change name (для распознанных лиц) — поменять имя человека (выбор из существующих или ввод нового)
